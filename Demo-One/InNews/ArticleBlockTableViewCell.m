...
- (void)loadCellWithText:(NSString *)text style:(UIArticleStyle)style
{
    ...
    switch (style) {
        ...
        case UIArticleStyleOne:
            ...
            break;
        case UIArticleStyleTwo:
            self.borderView.hidden = YES;
            [self.paragraphLabel setFrame:CGRectMake(5, 10, 300-10, 10) font:[CocoaNewsTextView getFontThree] text:text];
            self.paragraphLabel.textColor = [UIColor blackColor];
            break;
        default:
            break;
...
+ (CGFloat)cellHeightWithText:(NSString *)text style:(UIArticleStyle) style
{
    ...
    switch (style) {
        ...
        case UIArticleStyleOne:
            ...
            break;
        case UIArticleStyleTwo:
            [cocoaNewsLabel setFrame:CGRectMake(5, 10, 300-10, 10) font:[CocoaNewsTextView getFontThree] text:text];
            break;
        default:
            break;
    }
